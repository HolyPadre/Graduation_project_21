...
from .views import (payments, CustomAuthToken, CustomerSignupView, LogoutView, CustomerOnlyView, VendorOnlyView,
                    ManagerOnlyView, VendorSignupView, view_users)
...
urlpatterns = [
    ...
    path('users', view_users, name='view-users'),
    path('payment/<int:pk>', payments, name='payments'),
]
